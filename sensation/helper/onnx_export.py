...
import argparse
import torch.onnx
from segmentation import DeepLabV3PResNet50
...
def export_to_onnx(pytorch_model_path, onnx_model_path):
    ...
    model.layer.load_state_dict(state_dict)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pytorch",
        type=str,
        default="/home/amit/Downloads/deeplab_model_final.pth",
        help="Path to the PyTorch model file",
    )
    parser.add_argument(
        "--onnx",
        type=str,
        default="/home/amit/route-planning-for-the-visually-impaired/model_weights/deeplabv3resnet50.onnx",
